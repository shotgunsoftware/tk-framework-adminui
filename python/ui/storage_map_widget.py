...
"color: rgb(252, 98, 70);")
    ...
    def retranslateUi(self, StorageMapWidget):
        ...
        self.storage_lbl.setToolTip(QtGui.QApplication.translate("StorageMapWidget", "<p>These are the storage paths defined by your Flow Production Tracking site.</p>", None, QtGui.QApplication.UnicodeUTF8))
        self.storage_lbl.setText(QtGui.QApplication.translate("StorageMapWidget", "Storage:", None, QtGui.QApplication.UnicodeUTF8))
        self.storage_select_combo.setToolTip(QtGui.QApplication.translate("StorageMapWidget", "<p>These are the storage paths defined by your Flow Production Tracking site.</p>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.linux_lock.setToolTip(QtGui.QApplication.translate("StorageMapWidget", "<p>This path is locked since it has been saved to Flow Production Tracking. Visit Site Preferences > File Management to modify this path. WARNING: changing this path could break existing projects.</p>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.mac_lock.setToolTip(QtGui.QApplication.translate("StorageMapWidget", "<p>This path is locked since it has been saved to Flow Production Tracking. Visit Site Preferences > File Management to modify this path. WARNING: changing this path could break existing projects.</p>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.windows_lock.setToolTip(QtGui.QApplication.translate("StorageMapWidget", "<p>This path is locked since it has been saved to Flow Production Tracking. Visit Site Preferences > File Management to modify this path. WARNING: changing this path could break existing projects.</p>", None, QtGui.QApplication.UnicodeUTF8))
