...
class Ui_StorageMapWidget(object):
    def setupUi(self, StorageMapWidget):
        ...
        StorageMapWidget.resize(456, 164)
...
"color: rgb(160, 160, 160);")
        ...
        self.root_desc_layout.addWidget(self.root_description)
        self.root_desc_layout.setStretch(0, 1)
        self.root_desc_layout.setStretch(1, 10)
...
"color: rgb(252, 98, 70);")
        ...
        self.gridLayout_2.addWidget(self.storage_info, 2, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.windows_path_browse, 2, 2, 1, 1)
...
"color: rgb(120, 120, 120);")
        ...
        self.windows_path = QtGui.QLabel(self.path_frame)
        self.windows_path.setStyleSheet("font-size: 10px;\n"
"font: italic 10pt \"Courier\";\n"
"color: rgb(160, 160, 160);")
        self.windows_path.setText("")
        self.windows_path.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        ...
        self.linux_path = QtGui.QLabel(self.path_frame)
        self.linux_path.setStyleSheet("font-size: 10px;\n"
"font: italic 10pt \"Courier\";\n"
"color: rgb(160, 160, 160);")
        self.linux_path.setText("")
        self.linux_path.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
        ...
        self.gridLayout_3.addWidget(self.mac_path_browse, 1, 2, 1, 1)
...
"color: rgb(120, 120, 120);")
        ...
        self.gridLayout_3.addWidget(self.linux_path_browse, 0, 2, 1, 1)
        ...
        self.mac_path = QtGui.QLabel(self.path_frame)
        self.mac_path.setStyleSheet("font-size: 10px;\n"
"font: italic 10pt \"Courier\";\n"
"color: rgb(160, 160, 160);")
        self.mac_path.setText("")
        self.mac_path.setTextInteractionFlags(QtCore.Qt.TextSelectableByMouse)
...
"color: rgb(120, 120, 120);")
        ...
        spacerItem2 = QtGui.QSpacerItem(40, 4, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.root_name_layout.addItem(spacerItem2)
