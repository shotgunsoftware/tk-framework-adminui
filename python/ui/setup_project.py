...
"color: rgb(141, 143, 143);")
    ...
    def retranslateUi(self, Wizard):
        Wizard.setWindowTitle(QtGui.QApplication.translate("Wizard", "Flow Production Tracking Set Up Project Wizard", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.select_standard.setText(QtGui.QApplication.translate("Wizard", "Flow Production Tracking Default", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.local_file_link_lbl.setText(QtGui.QApplication.translate("Wizard", "Linking to local files must be enabled in your <a href=\"https://help.autodesk.com/view/SGSUB/ENU/?guid=SG_Administrator_ar_data_management_ar_linking_local_files_html\">Flow Production Tracking Preferences</a>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.distributed_config_subheader.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>The configuration will be uploaded to Flow Production Tracking. As a user starts up their content creation software, Toolkit will automatically download the configuration and all its dependencies.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
