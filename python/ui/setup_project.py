...
"color: rgb(160, 160, 160);")
        ...
        self.project_name_scroll_area_contents.setGeometry(QtCore.QRect(0, 0, 815, 189))
...
"color: rgb(141, 143, 143);")
    ...
    def retranslateUi(self, Wizard):
        ...
        self.storage_def_lbl.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>This configuration requires one or more filesystem roots where files will be stored. For each filesystem root required by this configuration on the left, specify an associated ShotGrid Local Storage on the right that defines the paths for the operating systems you use. <a href=\"https://help.autodesk.com/view/SGSUB/ENU/?guid=SG_Administrator_ar_data_management_ar_linking_local_files_html\"><span style=\" text-decoration: underline; color:#0000ff;\">More info…</span></a></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
