...
"color: rgb(160, 160, 160);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 606, 247))
...
"color: rgb(160, 160, 160);")
        ...
        self.storage_map_area_widget = QtGui.QWidget()
        self.storage_map_area_widget.setGeometry(QtCore.QRect(0, 0, 604, 216))
        ...
        self.local_file_link_lbl_layout = QtGui.QHBoxLayout()
        self.local_file_link_lbl_layout.setSpacing(0)
        self.local_file_link_lbl_layout.setObjectName("local_file_link_lbl_layout")
        spacerItem14 = QtGui.QSpacerItem(328, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.local_file_link_lbl_layout.addItem(spacerItem14)
        ...
        self.local_file_link_lbl_layout.addWidget(self.local_file_link_lbl)
        self.local_file_link_lbl_layout.setStretch(0, 1)
        self.local_file_link_lbl_layout.setStretch(1, 1)
        self.verticalLayout_10.addLayout(self.local_file_link_lbl_layout)
        ...
        self.project_name_scroll_area_contents.setGeometry(QtCore.QRect(0, 0, 656, 189))
        ...
        self.project_contents_layout.addItem(spacerItem15)
        ...
        self.gridLayout_3.addItem(spacerItem18, 7, 0, 1, 4)
        ...
        self.gridLayout_3.addItem(spacerItem19, 1, 0, 1, 4)
...
"color: rgb(141, 143, 143);")
    ...
    def retranslateUi(self, Wizard):
        ...
        self.label.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>Your url needs to end with .git, for example:<br/><br/><span style=\" font-family:\'Courier New,courier\'; font-size:12pt;\">https://github.com/shotgunsoftware/tk-config-default.git<br/>git@github.com:shotgunsoftware/tk-config-default.git</span></p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.storage_def_lbl.setText(QtGui.QApplication.translate("Wizard", "This configuration requires 1 storage root where it will store files. For each storage root required by this configuration on the left, specify an associated Local Storage on the right that defines the paths for the operating system you use. <a href=\"https://support.shotgunsoftware.com/hc/en-us/articles/219030938-Linking-to-local-files#how_to_set_up\">More info…</a>", None, QtGui.QApplication.UnicodeUTF8))
        self.local_file_link_lbl.setText(QtGui.QApplication.translate("Wizard", "<span style=\" font-size:16pt; vertical-align:sub;\">Linking to local files must be enabled in your Shotgun Preferences</span>", None, QtGui.QApplication.UnicodeUTF8))
