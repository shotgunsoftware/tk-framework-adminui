...
"color: rgb(160, 160, 160);")
        ...
        self.config_location_errors = QtGui.QLabel(self.config_location_frame)
        ...
        self.storage_grid_layout.addWidget(self.config_location_errors, 3, 0, 1, 4)
        ...
        self.gridLayout.addItem(spacerItem23, 5, 2, 1, 1)
...
"color: rgb(141, 143, 143);")
        ...
        self.gridLayout.addItem(spacerItem25, 0, 6, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem26, 7, 2, 1, 1)
    ...
    def retranslateUi(self, Wizard):
        ...
        self.distributed_config_subheader.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>The configuration will be uploaded to Shotgun. As a user starts up their content creation software, Toolkit will automatically download the configuration and all its dependencies.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
