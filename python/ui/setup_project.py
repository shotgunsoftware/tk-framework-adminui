...
"color: rgb(160, 160, 160);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 625, 278))
...
"color: rgb(141, 143, 143);")
    ...
    def retranslateUi(self, Wizard):
        ...
        self.label_default_config.setText(QtGui.QApplication.translate("Wizard", "<p style=\"line-height: 130%\">This includes all of the officially released engines and apps with a single root storage configuration that mimics a VFX/Animation workflow.</p>", None, QtGui.QApplication.UnicodeUTF8))
        self.select_multiroot_config.setText(QtGui.QApplication.translate("Wizard", "Multiroot", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.select_flame_config.setText(QtGui.QApplication.translate("Wizard", "Flame", None, QtGui.QApplication.UnicodeUTF8))
        self.label_multiroot_config_2.setText(QtGui.QApplication.translate("Wizard", "<p style=\"line-height: 130%\">This is the same as the Default configuration but also includes the Flame integration and a round-trip workflow between Flame and Nuke.</p", None, QtGui.QApplication.UnicodeUTF8))
        self.select_games_config.setText(QtGui.QApplication.translate("Wizard", "Games", None, QtGui.QApplication.UnicodeUTF8))
