...
"color: rgb(160, 160, 160);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 634, 274))
...
"color: rgb(160, 160, 160);")
        ...
        self.storage_map_area_widget.setGeometry(QtCore.QRect(0, 0, 632, 214))
...
"color: rgb(160, 160, 160);")
        ...
        self.project_name_scroll_area_contents.setGeometry(QtCore.QRect(0, 0, 684, 189))
        ...
        self.verticalLayout_12 = QtGui.QVBoxLayout(self.config_location_page)
        self.verticalLayout_12.setContentsMargins(25, 20, 25, 20)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.select_distributed_config = QtGui.QRadioButton(self.config_location_page)
        self.select_distributed_config.setFocusPolicy(QtCore.Qt.NoFocus)
        self.select_distributed_config.setStyleSheet("QRadioButton {\n"
"    font-size: 16px;\n"
"}\n"
"")
        self.select_distributed_config.setObjectName("select_distributed_config")
        self.verticalLayout_12.addWidget(self.select_distributed_config)
        self.distributed_config_subheader = QtGui.QLabel(self.config_location_page)
        self.distributed_config_subheader.setStyleSheet("font-size: 12px;\n"
"color: rgb(160, 160, 160);")
        self.distributed_config_subheader.setWordWrap(True)
        self.distributed_config_subheader.setIndent(20)
        self.distributed_config_subheader.setObjectName("distributed_config_subheader")
        self.verticalLayout_12.addWidget(self.distributed_config_subheader)
        self.select_centralized_config = QtGui.QRadioButton(self.config_location_page)
        self.select_centralized_config.setFocusPolicy(QtCore.Qt.NoFocus)
        self.select_centralized_config.setStyleSheet("QRadioButton {\n"
"    font-size: 16px;\n"
"}\n"
"")
        self.select_centralized_config.setChecked(True)
        self.select_centralized_config.setObjectName("select_centralized_config")
        self.verticalLayout_12.addWidget(self.select_centralized_config)
        self.centralized_config_subheader = QtGui.QLabel(self.config_location_page)
        self.centralized_config_subheader.setStyleSheet("font-size: 12px;\n"
"color: rgb(160, 160, 160);")
        self.centralized_config_subheader.setWordWrap(True)
        self.centralized_config_subheader.setIndent(20)
        self.centralized_config_subheader.setObjectName("centralized_config_subheader")
        self.verticalLayout_12.addWidget(self.centralized_config_subheader)
        self.config_location_frame = QtGui.QFrame(self.config_location_page)
        self.config_location_frame.setFrameShape(QtGui.QFrame.StyledPanel)
        self.config_location_frame.setFrameShadow(QtGui.QFrame.Raised)
        self.config_location_frame.setObjectName("config_location_frame")
        self.storage_grid_layout = QtGui.QGridLayout(self.config_location_frame)
        self.storage_grid_layout.setObjectName("storage_grid_layout")
        self.mac_path = QtGui.QLineEdit(self.config_location_frame)
        self.mac_path.setObjectName("mac_path")
        self.storage_grid_layout.addWidget(self.mac_path, 2, 1, 1, 1)
        self.windows_browse = QtGui.QPushButton(self.config_location_frame)
        ...
        self.linux_path = QtGui.QLineEdit(self.config_location_frame)
        self.linux_path.setObjectName("linux_path")
        self.storage_grid_layout.addWidget(self.linux_path, 1, 1, 1, 1)
        self.mac_browse = QtGui.QPushButton(self.config_location_frame)
        ...
        self.linux_browse = QtGui.QPushButton(self.config_location_frame)
        ...
        self.linux_label = QtGui.QLabel(self.config_location_frame)
        ...
        self.windows_path = QtGui.QLineEdit(self.config_location_frame)
        self.windows_path.setObjectName("windows_path")
        self.storage_grid_layout.addWidget(self.windows_path, 0, 1, 1, 1)
        self.windows_label = QtGui.QLabel(self.config_location_frame)
        ...
        self.mac_label = QtGui.QLabel(self.config_location_frame)
        ...
        spacerItem23 = QtGui.QSpacerItem(20, 0, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
...
"color: rgb(141, 143, 143);")
        ...
        Wizard.setTabOrder(self.project_name, self.windows_path)
        ...
        Wizard.setTabOrder(self.linux_browse, self.mac_path)
        Wizard.setTabOrder(self.mac_path, self.mac_browse)
        Wizard.setTabOrder(self.mac_browse, self.project_name_scroll_area)

    def retranslateUi(self, Wizard):
        Wizard.setWindowTitle(QtGui.QApplication.translate("Wizard", "ShotGrid Set Up Project Wizard", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.select_standard.setText(QtGui.QApplication.translate("Wizard", "ShotGrid Default", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.default_configs_page.setTitle(QtGui.QApplication.translate("Wizard", "<p></p><font size=18>&nbsp;Select a ShotGrid Configuration</font><p></p>", None, QtGui.QApplication.UnicodeUTF8))
        self.default_configs_page.setSubTitle(QtGui.QApplication.translate("Wizard", "&nbsp;", None, QtGui.QApplication.UnicodeUTF8))
        self.default_configs_subheader.setText(QtGui.QApplication.translate("Wizard", "<p style=\"line-height: 130%\">Choose the ShotGrid default that best matches your workflow and structure.</p>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.storage_def_lbl.setText(QtGui.QApplication.translate("Wizard", "This configuration requires one or more filesystem roots where files will be stored. For each filesystem root required by this configuration on the left, specify an associated ShotGrid Local Storage on the right that defines the paths for the operating systems you use. <a href=\"https://help.autodesk.com/view/SGSUB/ENU/?guid#how-do-i-set-up-local-file-storage-for-networked-resources-such-as-a-shared-element-library-\">More info…</a>", None, QtGui.QApplication.UnicodeUTF8))
        self.local_file_link_lbl.setText(QtGui.QApplication.translate("Wizard", "Linking to local files must be enabled in your <a href=\"https://help.autodesk.com/view/SGSUB/ENU/?guid=SG_Administrator_ar_data_management_ar_linking_local_files_html\">ShotGrid Preferences</a>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.config_location_page.setTitle(QtGui.QApplication.translate("Wizard", "<p></p><font size=18>&nbsp;Select Deployment</font><p></p>", None, QtGui.QApplication.UnicodeUTF8))
        self.config_location_page.setSubTitle(QtGui.QApplication.translate("Wizard", "&nbsp;", None, QtGui.QApplication.UnicodeUTF8))
        self.select_distributed_config.setText(QtGui.QApplication.translate("Wizard", "Distributed Setup", None, QtGui.QApplication.UnicodeUTF8))
        self.distributed_config_subheader.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>The configuration will be uploaded to ShotGrid. As a user starts up their content creation software, Toolkit will automatically download the configuration and all its dependencies.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        self.select_centralized_config.setText(QtGui.QApplication.translate("Wizard", "Centralized Setup", None, QtGui.QApplication.UnicodeUTF8))
        self.centralized_config_subheader.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>Your Project\'s pipeline configuration will to be installed in a shared location. All users need to access the configuration from this location. If you use multiple operating systems, enter the equivalent path for each.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
