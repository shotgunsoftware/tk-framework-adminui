...
"color: rgb(160, 160, 160);")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 629, 254))
...
"color: rgb(160, 160, 160);")
        ...
        self.project_name_scroll_area_contents.setGeometry(QtCore.QRect(0, 0, 307, 191))
        ...
        self.project_contents_layout.addItem(spacerItem14)
        ...
        self.gridLayout_3.addItem(spacerItem17, 7, 0, 1, 4)
        ...
        self.gridLayout_3.addItem(spacerItem18, 1, 0, 1, 4)
        ...
        self.gridLayout.addItem(spacerItem22, 5, 2, 1, 1)
...
"color: rgb(141, 143, 143);")
        ...
        self.gridLayout.addItem(spacerItem24, 0, 6, 1, 1)
        ...
        self.gridLayout.addItem(spacerItem25, 7, 2, 1, 1)
    ...
    def retranslateUi(self, Wizard):
        ...
        self.label_default_config.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>This configuration matches how projects behave before any configuration, but adds an example directory structure and related tools (such as workfile management).</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_multiroot_config.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>This is the configuration that matches the behavior before every project had a default configuration.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
