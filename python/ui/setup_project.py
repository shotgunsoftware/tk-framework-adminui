...
"color: rgb(141, 143, 143);")
    ...
    def retranslateUi(self, Wizard):
        ...
        self.distributed_config_subheader.setText(QtGui.QApplication.translate("Wizard", "<html><head/><body><p>The configuration will be uploaded to Shotgun. Users will automatically download the configuration and its dependencies.</p></body></html>", None, QtGui.QApplication.UnicodeUTF8))
